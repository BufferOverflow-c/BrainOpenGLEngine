...
---
This is my attempt to get Low Level Game Dev's cmakeSetup working on Mac, I'm sure there are some things that I either missed or got wrong. 
Feel free to open a issue or PR wish suggestions or updates.

## Linked Libs
___
This is a CMake setup that loads glfw, OpenGL, stb_image, stb_truetype, and a custom 2d library. It works on Windows, Linux, and Mac.

## Build
___
UNIX based systems should be able to run using:
./unixBuilder.sh
